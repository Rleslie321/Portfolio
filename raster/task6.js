...
// ################
        ...
        vec3 n = normalize(vec3(normalFixer*vec4(Normal,0.0)));
        float r = distance(LightPosition, position);
        vec3 l = normalize(LightPosition - position);
        Color = ka + kd*(LightIntensity/(r*r))*max(0.0, dot(n,l));
...
// ################ Edit your code below
// ################
    var normalFixer = SimpleMatrix.inverse(model);
    normalFixer = normalFixer.transpose();
    ...
    gl.uniformMatrix4fv(gl.getUniformLocation(this.shaderProgram, "normalFixer"), false, normalFixer.transpose().m);
